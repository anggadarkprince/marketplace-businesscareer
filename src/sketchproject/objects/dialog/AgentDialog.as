package sketchproject.objects.dialog
{
	...
	public class AgentDialog extends DialogOverlay
	{
		...
		{			
			...
			agentId = new TextField(135, 30, "action", Assets.getFont(Assets.FONT_SSREGULAR).fontName, 13, 0x333333);
			...
			district = new TextField(135, 30, "action", Assets.getFont(Assets.FONT_SSREGULAR).fontName, 13, 0x333333);
			...
			mainRole = new TextField(135, 30, "action", Assets.getFont(Assets.FONT_SSREGULAR).fontName, 13, 0x333333);
			...
			buyingPower = new TextField(135, 30, "action", Assets.getFont(Assets.FONT_SSREGULAR).fontName, 13, 0x333333);
			...
			emotion = new TextField(135, 30, "action", Assets.getFont(Assets.FONT_SSREGULAR).fontName, 13, 0x333333);
			...
			education = new TextField(135, 30, "action", Assets.getFont(Assets.FONT_SSREGULAR).fontName, 13, 0x333333);
			...
			art = new TextField(135, 30, "action", Assets.getFont(Assets.FONT_SSREGULAR).fontName, 13, 0x333333);
			...
			athletic = new TextField(135, 30, "action", Assets.getFont(Assets.FONT_SSREGULAR).fontName, 13, 0x333333);
			...
			actionWill = new TextField(135, 30, "action", Assets.getFont(Assets.FONT_SSREGULAR).fontName, 13, 0x333333);
			...
			priceSensitivity = new TextField(135, 30, "action", Assets.getFont(Assets.FONT_SSREGULAR).fontName, 13, 0x333333);
			...
			priceThreshold = new TextField(135, 30, "action", Assets.getFont(Assets.FONT_SSREGULAR).fontName, 13, 0x333333);
			...
			qualitySensitivity = new TextField(135, 30, "action", Assets.getFont(Assets.FONT_SSREGULAR).fontName, 13, 0x333333);
			...
			qualityThreshold = new TextField(135, 30, "action", Assets.getFont(Assets.FONT_SSREGULAR).fontName, 13, 0x333333);
			...
			recommendation = new TextField(135, 30, "action", Assets.getFont(Assets.FONT_SSREGULAR).fontName, 13, 0x333333);
			...
			disqualification = new TextField(135, 30, "action", Assets.getFont(Assets.FONT_SSREGULAR).fontName, 13, 0x333333);
			...
			environmentEval = new TextField(135, 30, "action", Assets.getFont(Assets.FONT_SSREGULAR).fontName, 13, 0x333333);
			...
			productEval = new TextField(135, 30, "action", Assets.getFont(Assets.FONT_SSREGULAR).fontName, 13, 0x333333);
			...
			adverEval = new TextField(135, 30, "action", Assets.getFont(Assets.FONT_SSREGULAR).fontName, 13, 0x333333);
			...
			respondEval = new TextField(135, 30, "action", Assets.getFont(Assets.FONT_SSREGULAR).fontName, 13, 0x333333);
			...
			facing = new TextField(135, 30, "action", Assets.getFont(Assets.FONT_SSREGULAR).fontName, 13, 0x333333);
			...
			deltaX = new TextField(135, 30, "action", Assets.getFont(Assets.FONT_SSREGULAR).fontName, 13, 0x333333);
			...
			deltaY = new TextField(135, 30, "action", Assets.getFont(Assets.FONT_SSREGULAR).fontName, 13, 0x333333);
			...
			speed = new TextField(135, 30, "action", Assets.getFont(Assets.FONT_SSREGULAR).fontName, 13, 0x333333);
			...
			position = new TextField(135, 30, "action", Assets.getFont(Assets.FONT_SSREGULAR).fontName, 13, 0x333333);
			...
			coordinate = new TextField(135, 30, "action", Assets.getFont(Assets.FONT_SSREGULAR).fontName, 13, 0x333333);
			...
			cartesian = new TextField(135, 30, "action", Assets.getFont(Assets.FONT_SSREGULAR).fontName, 13, 0x333333);
			...
			destination = new TextField(135, 30, "action", Assets.getFont(Assets.FONT_SSREGULAR).fontName, 13, 0x333333);
			...
			path = new TextField(135, 30, "action", Assets.getFont(Assets.FONT_SSREGULAR).fontName, 13, 0x333333);
			...
			isMoving = new TextField(135, 30, "action", Assets.getFont(Assets.FONT_SSREGULAR).fontName, 13, 0x333333);
