package sketchproject.objects.dialog
{
	...
	/**
	 * Show information and issues in game world.
	 *
	 * @author Angga
	 */
	public class TrendDialog extends DialogOverlay
	{
		...
		public function TrendDialog()
		{
			...
			trendList = new TextField(380, 100, "", Assets.getFont(Assets.FONT_SSREGULAR).fontName, 14, 0x333333);
			...
			eventList = new TextField(380, 130, "No Event", Assets.getFont(Assets.FONT_SSREGULAR).fontName, 14, 0x333333);
		...
		public function update():void
		{
			...
			trendList.text = "Trend ketertarikan konsumen terhadap event dan toko :\nEducation : " + education + "  Art : " + art + "  Athletic : " + athletic;
