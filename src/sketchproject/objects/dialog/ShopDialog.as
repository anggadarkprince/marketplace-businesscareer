package sketchproject.objects.dialog
{
	...
	public class ShopDialog extends DialogOverlay
	{
		...
		public function getShopData():void
		{
			...
			trace("shop benefit--------------");
			trace("health",(incentiveReward.color == 0xFF7979)?1:0);
			trace("education",(incentiveCareer.color == 0xFF7979)?1:0);
			trace("additional financial",(incentiveCultural.color == 0xFF7979)?1:0);
			trace("police practice",(incentivePersonalization.color == 0xFF7979)?1:0);
		}
